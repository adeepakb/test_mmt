package com.framework.selenium.runners;
...
public class Hook {
    ...
    public   ExtentHtmlReporter extentHtmlReporter = new ExtentHtmlReporter(System. getProperty("user.dir")+"/src/resources/report.html");
